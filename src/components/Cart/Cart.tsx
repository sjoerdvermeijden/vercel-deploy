...
function Cart({ }: Props) {
    ...
    return (
        <div className='h-full w-full absolute left-0 top-0 w-full lg:relative lg:w-80  bg-gray-200 p-5'>
            <div className="cart-heading justify-center items-center mb-5 flex">
                <h3 className='text-2xl text-center mr-auto lg:mr-0'>Winkelmandje</h3>
                <button type="button" className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 lg:hidden">
